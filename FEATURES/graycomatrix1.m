function [GLCMS,SI] = graycomatrix1(varargin)
...
%   $Revision: 1.1.8.10 $  $Date: 2011/08/09 17:49:57 $

[I, Offset, NL, GL, makeSymmetric, mask] = ParseInputs(varargin{:});
...
outsideBounds = unique([outsideBounds; maskInd]);
...
%-----------------------------------------------------------------------------
function [I, offset, nl, gl, sym, mask] = ParseInputs(varargin)
...
if nargin ~= 1
  ...
  paramStrings = {'Offset','NumLevels','GrayLimits','Symmetric', 'Mask'};
