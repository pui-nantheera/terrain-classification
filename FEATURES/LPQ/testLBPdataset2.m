...
blurType = 'gaussian';%'gaussian';% 'disk';
...
for probcase = 1:50
    ...
    % extract feature
    trainingFeatures = zeros(totalTrain*totalClass,59);
    ...
    for cnum = 1:totalClass
        for k = 1:totalTrain
            ...
            trainingFeatures(count,:) = findLBPhist(img);
    ...
    for n = 1:length(angleRange)
        ...
        for numradius = 1:totalBlurRange
            ...
            % extract feature
            testingFeatures = zeros(totalTest*totalClass,59);
            ...
            for cnum = 1:totalClass
                for k = 1:totalTest
                    ...
                    testingFeatures(count,:) = findLBPhist(img);
