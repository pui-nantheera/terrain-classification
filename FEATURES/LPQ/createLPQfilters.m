function LPQfilters = createLPQfilters(winSize,numAngl,half)
...
ang=0:(half*pi/numAngl):(half*pi-half*pi/numAngl); % Initialize rotation angles. Rotation is counter clock wise in image.
